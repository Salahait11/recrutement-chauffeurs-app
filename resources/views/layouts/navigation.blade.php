        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('driving-tests.index')" :active="request()->routeIs('driving-tests.index')">
                        {{ __('Tests Conduite') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('admin.absences.index')" :active="request()->routeIs('admin.absences.*')">
                        {{ __('Absences') }}
                    </x-nav-link>
